 ...
 * https://github.com/xnu/jQuery-File-Upload
 *
...
(function (factory) {
    ...
    var originalAdd = $.xnu.fileupload.prototype.options.add;
...
(function (factory) {
    ...
    $.xnu.fileupload.prototype.options.processQueue.unshift(
        {
...
//            previewMinHeight: 16,            
            ...
            previewCrop: false,
            // Define if true images should be resized as canvas elements:
            previewCanvas: true
        },
...
(function (factory) {
    ...
    $.xnu.fileupload.prototype.options.processQueue.push(
        {
            action: 'validate',
