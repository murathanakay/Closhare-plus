    ...
    Filestyle.prototype = {
        ...
        classIcon: function (value) {
            if (value !== undefined) {
                ...
                if (this.options.classButton.search(/btn-inverse|btn-primary|btn-danger|btn-warning|btn-success/i) !== -1) {
                    this.$elementFilestyle.find('label').find('i').attr({'class': 'icon icon-white '+this.options.classIcon});
                } else {
                    this.$elementFilestyle.find('label').find('i').attr({'class': 'icon '+this.options.classIcon});
                }
            } else {
        ...
        htmlIcon: function () {
            if (this.options.icon) {
                ...
                return '<i class="icon '+colorIcon+this.options.classIcon+'"></i> ';
            } else {
                return '';
            }
        },
